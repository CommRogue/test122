# THIS FILE CONTAINS ADDITIONAL FUNCTIONALITY TO QT'S QTABWIDGET, SPECIFICALLY DETACHABLE TABS
# THIS FILE HAS NOT BEEN WRITTEN BY ME, AND ALL CREDIT GOES TO STACKOVERFLOW USER BLACKWOOD
# https://stackoverflow.com/a/47267196
