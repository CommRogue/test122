...
class DUDialog(QtWidgets.QDialog):
...
class DownloadDialog(DUDialog):
    ...
    def setupUi(self, DownloadDialog):
        ...
        self.encryptRadio = QtWidgets.QRadioButton(DownloadDialog)
        self.doNotEncryptRadio = QtWidgets.QRadioButton(DownloadDialog)
        sizePolicy2 = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        self.encryptRadio.setSizePolicy(sizePolicy2)
        self.doNotEncryptRadio.setSizePolicy(sizePolicy2)
        self.encryptRadio.setText("Secured File Transfer (slow)")
        self.doNotEncryptRadio.setText("Unsecured File Transfer (fast)")
        self.encryptButtonGroup = QtWidgets.QButtonGroup(DownloadDialog)
        self.encryptButtonGroup.setObjectName("encryptButtonGroup")
        self.encryptButtonGroup.addButton(self.encryptRadio)
        self.encryptButtonGroup.addButton(self.doNotEncryptRadio)
        self.encryptRadio.setChecked(True)
        self.encryptRadio.setObjectName("encryptRadio")
        self.horizontalLayout_4.addWidget(self.encryptRadio)
        self.doNotEncryptRadio.setObjectName("doNotEncryptRadio")
        self.horizontalLayout_4.addWidget(self.doNotEncryptRadio)
...
class UploadDialog(DUDialog):
    def reject(self):
        self.controller.closeButtonClicked()

    def custom(self):
        self.b1 = self.buttonBox.addButton("Start Upload", QtWidgets.QDialogButtonBox.YesRole)
        self.b1.clicked.connect(self.controller.on_uploadbutton_clicked)
        self.b1.setEnabled(False)
        self.b2 = self.buttonBox.addButton("Cancel", QtWidgets.QDialogButtonBox.RejectRole)
        self.b2.clicked.connect(self.controller.closeButtonClicked)
        self.chooseDirectoryButton.clicked.connect(self.controller.choose_locationClicked)
        # self.remoteDirectoryText.setText(self.fileExplorerItem.path)
        # self.downloadLocationText.setText(self.localDownloadDirectory)
        # self.fileSizeText.setText(self.fileExplorerItem.sizeStr)
    ...
    def setupUi(self, DownloadDialog):
        ...
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_2.addWidget(self.label_2)
        self.localDirectoryText = QtWidgets.QLineEdit(DownloadDialog)
        self.localDirectoryText.setReadOnly(True)
        self.localDirectoryText.setObjectName("localDirectoryText")
        self.horizontalLayout_2.addWidget(self.localDirectoryText)
        self.chooseDirectoryButton = QtWidgets.QToolButton(DownloadDialog)
        self.chooseDirectoryButton.setObjectName("chooseDirectoryButton")
        self.horizontalLayout_2.addWidget(self.chooseDirectoryButton)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label = QtWidgets.QLabel(DownloadDialog)
    ...
    def retranslateUi(self, DownloadDialog):
        ...
        DownloadDialog.setWindowTitle(_translate("DownloadDialog", "Download File...."))
        self.label_3.setText(_translate("DownloadDialog",
                                        "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Upload Item/s</span></p></body></html>"))
        self.label_2.setText(_translate("DownloadDialog", "Local file or directory to upload"))
        self.chooseDirectoryButton.setText(_translate("DownloadDialog", "..."))
        self.label.setText(_translate("DownloadDialog", "Location to upload to"))
        self.fileSizeLabel.setText(_translate("DownloadDialog", "File size: "))
        self.downloadTimeLabel.setText(_translate("DownloadDialog", "Estimated time to upload (5 mb/s):"))